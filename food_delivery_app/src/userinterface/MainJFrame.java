...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginJButton.setForeground(new java.awt.Color(255, 255, 204));
        ...
        logoutJButton.setBackground(new java.awt.Color(0, 0, 51));
        logoutJButton.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        logoutJButton.setForeground(new java.awt.Color(255, 255, 204));
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
       ...
       UserAccount uAcc = system.getUserAccountDirectory().authenticateUser(username, password);
       
       if (uAcc == null) {
           JOptionPane.showMessageDialog(this, "Invalid account credentials.");
           return;
       }
       JPanel newPanel = uAcc.getRole().createWorkArea(container, uAcc, system);
       container.add("adminWorkArea", newPanel);
